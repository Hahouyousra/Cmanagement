...
import com.mcommande.microservicecommandes.comfigurations.ApplicationPropertiesConfigurations;
...
public class CommandeController implements HealthIndicator {
    ...
    public List<Commande> findAll()
    {
        ...
        if(commandes.isEmpty())
            throw new CommandeNotFoundException("No Commande exist");
        Collections.sort(commandes);
        System.out.println(propertiesConfigurations.getCommandeslast());
        return commandes.subList(0,propertiesConfigurations.getCommandeslast());
    }
